...
public class InstagramAuthActivity extends SimpleAuthActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    clientId = AppUtils.getMetaDataValue(this, getString(R.string.sa_com_jaychang_sa_instagramClientId));
    clientSecret = AppUtils.getMetaDataValue(this, getString(R.string.sa_com_jaychang_sa_instagramClientSecret));
    redirectUri = AppUtils.getMetaDataValue(this, getString(R.string.sa_com_jaychang_sa_instagramRedirectUri));
