...
```java
dependencies {
    compile 'com.jaychang:simpleauth:2.0.2'
    // if you want to use facebook auth
    compile 'com.jaychang:simpleauth-facebook:2.0.2'
    // if you want to use google auth
    compile 'com.jaychang:simpleauth-google:2.0.2'
    // if you want to use instagram auth
    compile 'com.jaychang:simpleauth-instagram:2.0.2'
    // if you want to use twitter auth
    compile 'com.jaychang:simpleauth-twitter:2.0.2'
}
```
